<template>
  <div style="margin: 30px 150px">
    <SearchBar style="margin-bottom: 15px" v-model="searchQuery"></SearchBar>
    <TheTable :table-data="data" :search-query="searchQuery"></TheTable>
  </div>
</template>
...
import TheTable, { TableDataType } from "../components/TheTable.vue";
